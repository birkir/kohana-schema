...
abstract class Database_Constraint {
	 ...
	 */
	public static function primary_key($keys, $table)
	{
	 ...
	 *
	 * @param	string	The name of the column to index.
	 * @return	Database_Constraint_Index	The constraint object.
	 */
	public static function index($keys)
	{
		return new Database_Constraint_Index($keys);
	}
